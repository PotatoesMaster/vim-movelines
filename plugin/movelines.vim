" Copied from http://vim.wikia.com/wiki/VimTip191#Swapping_lines
" Added mapping for the console.

if exists("g:loaded_movelines") || &cp
  finish
endif
let g:loaded_movelines = 1
...
xnoremap <silent> <Esc>Oa :<C-u>call MoveVisualUp()<CR>
xnoremap <silent> <Esc>Ob :<C-u>call MoveVisualDown()<CR>
